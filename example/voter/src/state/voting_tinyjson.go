...
func tinyjsonEa1f3371DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(in *jlexer.Lexer, out *Voting) {
...
func tinyjsonEa1f3371EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(out *jwriter.Writer, in Voting) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Voting) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjsonEa1f3371EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(&w, v)
...
func (v *Voting) UnmarshalJSON(data []byte) error {
	...
	tinyjsonEa1f3371DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(&r, v)
	return r.Error()
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *Voting) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjsonEa1f3371DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(l, v)
}
func tinyjsonEa1f3371DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState1(in *jlexer.Lexer, out *Tally) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonEa1f3371EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState1(out *jwriter.Writer, in Tally) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Tally) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjsonEa1f3371EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Tally) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	tinyjsonEa1f3371DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState1(&r, v)
	return r.Error()
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *Tally) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjsonEa1f3371DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState1(l, v)
}
