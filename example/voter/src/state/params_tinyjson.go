...
func tinyjson54f20b6DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(in *jlexer.Lexer, out *Params) {
...
func tinyjson54f20b6EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(out *jwriter.Writer, in Params) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Params) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjson54f20b6EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(&w, v)
...
func (v *Params) UnmarshalJSON(data []byte) error {
	...
	tinyjson54f20b6DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(&r, v)
	return r.Error()
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *Params) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson54f20b6DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcState(l, v)
}
