...
func tinyjson8d55ca79DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(in *jlexer.Lexer, out *VoteRequest) {
...
func tinyjson8d55ca79EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(out *jwriter.Writer, in VoteRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v VoteRequest) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjson8d55ca79EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(&w, v)
...
func (v *VoteRequest) UnmarshalJSON(data []byte) error {
	...
	tinyjson8d55ca79DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(&r, v)
	return r.Error()
}
