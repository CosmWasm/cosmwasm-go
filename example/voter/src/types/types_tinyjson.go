...
func tinyjsonA17a9c65DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(in *jlexer.Lexer, out *Params) {
...
func tinyjsonA17a9c65EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(out *jwriter.Writer, in Params) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Params) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjsonA17a9c65EncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(&w, v)
...
func (v *Params) UnmarshalJSON(data []byte) error {
	...
	tinyjsonA17a9c65DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(&r, v)
	return r.Error()
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *Params) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjsonA17a9c65DecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(l, v)
}
