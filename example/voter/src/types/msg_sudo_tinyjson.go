...
func tinyjson18e7fdDecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(in *jlexer.Lexer, out *MsgSudo) {
...
func tinyjson18e7fdEncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(out *jwriter.Writer, in MsgSudo) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v MsgSudo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjson18e7fdEncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(&w, v)
...
func (v *MsgSudo) UnmarshalJSON(data []byte) error {
	...
	tinyjson18e7fdDecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(&r, v)
	return r.Error()
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *MsgSudo) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson18e7fdDecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes(l, v)
}
func tinyjson18e7fdDecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes1(in *jlexer.Lexer, out *ChangeCostRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson18e7fdEncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes1(out *jwriter.Writer, in ChangeCostRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ChangeCostRequest) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	tinyjson18e7fdEncodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *ChangeCostRequest) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	tinyjson18e7fdDecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes1(&r, v)
	return r.Error()
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *ChangeCostRequest) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson18e7fdDecodeGithubComCosmWasmCosmwasmGoExampleVoterSrcTypes1(l, v)
}
