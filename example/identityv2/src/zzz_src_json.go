	...
	for !in.IsDelim('}') {
		...
		case "query_imported":
			if in.IsNull() {
				...
				tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp(in, out.QueryImported)
			}
		default:
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src(out *jwriter.Writer, in QueryMsg) {
	...
	if in.QueryImported != nil {
		...
		tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp(out, *in.QueryImported)
	}
	out.RawByte('}')
}
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp(in *jlexer.Lexer, out *imp.ImportedQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp(out *jwriter.Writer, in imp.ImportedQuery) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
}
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src1(in *jlexer.Lexer, out *QueryIdentity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src1(out *jwriter.Writer, in QueryIdentity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src2(in *jlexer.Lexer, out *Person) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src2(out *jwriter.Writer, in Person) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Address != "" {
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src3(in *jlexer.Lexer, out *MsgUpdateCity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src3(out *jwriter.Writer, in MsgUpdateCity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.City != "" {
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src4(in *jlexer.Lexer, out *MsgMigrate) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src4(out *jwriter.Writer, in MsgMigrate) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src5(in *jlexer.Lexer, out *MsgInstantiate) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src5(out *jwriter.Writer, in MsgInstantiate) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src6(in *jlexer.Lexer, out *MsgDelete) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src6(out *jwriter.Writer, in MsgDelete) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src7(in *jlexer.Lexer, out *MsgCreateIdentity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src7(out *jwriter.Writer, in MsgCreateIdentity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src8(in *jlexer.Lexer, out *ExecuteMsg) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "imported_message":
			if in.IsNull() {
				...
				tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp1(in, out.ImportedMessage)
			}
		default:
			in.AddError(&jlexer.LexerError{
				Offset: in.GetPos(),
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2Src8(out *jwriter.Writer, in ExecuteMsg) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.ImportedMessage != nil {
		...
		tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp1(out, *in.ImportedMessage)
	}
	out.RawByte('}')
}
...
func tinyjson97bc4d59DecodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp1(in *jlexer.Lexer, out *imp.ImportedMessage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson97bc4d59EncodeGithubComCosmwasmCosmwasmGoExampleIdentityv2SrcImp1(out *jwriter.Writer, in imp.ImportedMessage) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
